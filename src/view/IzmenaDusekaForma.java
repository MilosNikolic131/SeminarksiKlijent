 ...
 * @author Master
 */
public class IzmenaDusekaForma extends javax.swing.JDialog {

    KlijentForma forma;
    Dusek ucitani;

    /**
     * Creates new form IzmenaDusekaForma
     */
    public IzmenaDusekaForma(KlijentForma forma) {
        initComponents();
        this.forma = forma;
        srediFormu();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (tblTabela.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(this, "Sistem ne moze da ucita dusek po zadatoj vrednosti.");
            return;
        }
        ...
        JOptionPane.showMessageDialog(this, "Sistem je ucitao dusek po zadatoj vrednosti.");
        new IzmenaDusekaDijalog(ucitani, this).setVisible(true);
...
//            java.util.logging.Logger.getLogger(IzmenaDusekaForma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                IzmenaDusekaForma dialog = new IzmenaDusekaForma(new javax.swing.JFrame(), true);
...
private void srediFormu() {
    ...
    private void pretraziMaterijal() {
        ...
        if (listaKonacana.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Sistem ne moze da nadje dusek po zadatoj vrednosti");
            return;
        }
