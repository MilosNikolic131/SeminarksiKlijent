 ...
 * @author Master
 */
public class PretrazivanjeDusekaForma extends javax.swing.JDialog {
     ...
     */
    public PretrazivanjeDusekaForma(KlijentForma forma) {
        initComponents();
        this.forma = forma;
        srediFormu();
    }
...
//            java.util.logging.Logger.getLogger(PretrazivanjeDusekaForma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                PretrazivanjeDusekaForma dialog = new PretrazivanjeDusekaForma(new javax.swing.JFrame(), true);
